...
const Contact = () => {
  ...
  const socialIcons = {
    facebook: (
      <a href="https://www.facebook.com/people/Orange-Office-Technologies-Pvt-Ltd/61566454888473/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
        <Facebook size={20} />
      </a>
    ),
    linkedin: (
      <a href="https://www.linkedin.com/company/orange-office-technologies-pvt-ltd/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
        <Linkedin size={20} />
      </a>
    )
  };
        ...
        <section className="container mx-auto px-4 mt-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className={cn("text-xl mb-6 text-gray-700 max-w-2xl mx-auto transform transition-all duration-700 delay-100", isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
              Discover how our innovative solutions can transform your logistics operations and drive business growth
            </p>
          </div>
        </section>
      </GradientBackground>
            ...
            <div className={cn("lg:col-span-3 transform transition-all duration-700 delay-200", isPageLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
              <Card className="overflow-hidden border-none rounded-2xl shadow-2xl backdrop-blur-lg bg-white/90 hover:shadow-orange-200/20 hover:shadow-2xl transition-all duration-500">
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  <form className="space-y-5" action="https://formsubmit.co/karthikjungleemara@gmail.com" method="POST" target="_blank">
                    {/* Anti-bot field */}
                    <input type="text" name="_honey" style={{ display: 'none' }} />
                    <input type="hidden" name="_captcha" value="false" />
                    <input type="hidden" name="_next" value="https://orangeot.com/thank-you" />
                    ...
                    <div className="space-y-1 group">
                      ...
                      <div className="relative">
                        <Input id="phone" name="phone" type="tel" placeholder="+91 98765 43210" className="pl-10 bg-gray-50/50 border-gray-200 h-11" value={formData.phone} onChange={handleInputChange} />
                    ...
                    <div className="space-y-1">
                      ...
                      <Textarea id="message" name="message" placeholder="Please provide details about your inquiry..." className="bg-gray-50/50 border-gray-200 min-h-[120px]" value={formData.message} onChange={handleInputChange} required />
                    </div>

                    <Button type="submit" className="w-full h-11 text-base bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700">
                  ...
                  {officeLocations.map((office, index) => (
                    <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden group">
                      ...
                      <CardContent className="p-5">
                        <h3 className="font-bold text-lg mb-2 flex items-center text-gray-800 group-hover:text-orange-500">
