      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">Orange Office Technologies Pvt Ltd is a specialized back-office service provider catering exclusively to the global shipping, freight forwarding, and third-party logistics (3PL) industries. With a strong foundation in logistics domain expertise and digital innovation, OOT delivers integrated operational support and IT solutions that streamline processes, enhance productivity, and drive sustainable growth across the logistics value chain.</p>
      ...
      <div className="relative">
        <div className="rounded-xl overflow-hidden shadow-lg border-4 border-orange-200 my-0">
          <img
              ...
              alt="Team working with data" className="object-cover w-full h-full" src="/lovable-uploads/d51cac68-97ba-47e3-8f1a-50f4fb40719a.png" />
        </div>
      </div>
