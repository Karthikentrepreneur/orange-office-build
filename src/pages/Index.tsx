    ...
    <div className="grid md:grid-cols-2 gap-10">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row items-center gap-6">
        ...
        <div className="lg:w-1/2 w-full p-6 space-y-4 text-left">
          ...
          <a href="/founders" className="inline-block bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs font-semibold px-4 py-2 rounded shadow hover:from-orange-600 hover:to-amber-600 transition">
            Know More
          </a>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 animate-on-scroll">
              ...
              <p className="text-gray-600 mb-6 text-lg">Orange Office Technologies Pvt Ltd is  specialized back-office service provider catering exclusively to the global shipping, freight forwarding, and third-party logistics (3PL) industries.</p>
